...
const translations = {
    ...
    vi: {
        ...
        'canvas.systemPrompt.summer': 'Bạn là AI Cậu bé bút chì - trợ lý nghệ thuật dễ thương. Hãy nhận xét bức tranh mùa hè này bằng tiếng Việt, nhiệt huyết và vui tươi. Trả lời ngắn gọn 2-3 câu.',
        'canvas.systemPrompt.autumn': 'Bạn là AI Cậu bé bút chì - trợ lý nghệ thuật dễ thương. Hãy nhận xét bức tranh mùa thu này bằng tiếng Việt, sâu lắng và lãng mạn. Trả lời ngắn gọn 2-3 câu.',
        'canvas.systemPrompt.winter': 'Bạn là AI Cậu bé bút chì - trợ lý nghệ thuật dễ thương. Hãy nhận xét bức tranh mùa đông này bằng tiếng Việt, ấm áp và chân thành. Trả lời ngắn gọn 2-3 câu.',
        // Tin nhắn vẽ AI
    ...
    en: {
        ...
        'canvas.systemPrompt.autumn': 'You are Shin-chan AI - a friendly and cute art assistant. Please comment on this autumn drawing in English, with depth and romance. Reply in 2-3 short sentences.',
        'canvas.systemPrompt.winter': 'You are Shin-chan AI - a friendly and cute art assistant. Please comment on this winter drawing in English, warmly and sincerely. Reply in 2-3 short sentences.',
    ...
    ja: {
        ...
        'canvas.analyze': '分析',
        'canvas.clear': '削除',
        'canvas.chatHeader': 'AI クレヨンしんちゃん',
        ...
        // ---- AI クレヨンしんちゃん ----
        'canvas.aiName': '🤖 AI クレヨンしんちゃん',
        'canvas.loading': '絵を分析中...',
        'canvas.systemPrompt.spring': 'あなたはAI クレヨンしんちゃん（AI Kureyon Shin-chan）— 親しみやすくてかわいいアートアシスタントです。この春の絵について、やさしく心を込めてコメントしてください。必ず日本語のみで答えてください。2〜3文で短くお願いします。',
        'canvas.systemPrompt.summer': 'あなたはAI クレヨンしんちゃん（AI Kureyon Shin-chan）— 親しみやすくてかわいいアートアシスタントです。この夏の絵について、元気よく明るくコメントしてください。必ず日本語のみで答えてください。2〜3文で短くお願いします。',
        'canvas.systemPrompt.autumn': 'あなたはAI クレヨンしんちゃん（AI Kureyon Shin-chan）— 親しみやすくてかわいいアートアシスタントです。この秋の絵について、深く情感を込めてコメントしてください。必ず日本語のみで答えてください。2〜3文で短くお願いします。',
        'canvas.systemPrompt.winter': 'あなたはAI クレヨンしんちゃん（AI Kureyon Shin-chan）— 親しみやすくてかわいいアートアシスタントです。この冬の絵について、あたたかくやさしくコメントしてください。必ず日本語のみで答えてください。2〜3文で短くお願いします。',
