...
function drawFlowers() {
    ...
    saveState();
    showAiMessage(t('canvas.spring.drew.flowers'));
}
...
function drawRiceField() {
    ...
    saveState();
    showAiMessage(t('canvas.spring.drew.rice'));
}
...
async function analyzeDrawing() {
    ...
    try {
        ...
        const systemPrompt = t('canvas.systemPrompt.spring');
        ...
        showAiMessage(t('canvas.error.spring'));
    }
}
...
function showLoadingMessage() {
    ...
    loadingDiv.innerHTML = `<i class="fas fa-spinner fa-spin"></i> ${t('canvas.loading')}`;
...
// Hiển thị tin nhắn từ Tiểu AI (luôn dùng style 'ai')
