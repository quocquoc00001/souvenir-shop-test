...
function drawSnow() {
    ...
    saveState();
    showAiMessage(t('canvas.winter.drew.snow'));
}
...
function drawFireplace() {
    ...
    ctx.stroke();
    saveState();
    showAiMessage(t('canvas.winter.drew.fire'));
}
...
async function analyzeDrawing() {
    ...
    try {
        ...
        const systemPrompt = t('canvas.systemPrompt.winter');
        ...
        removeLoadingMessage();
        showAiMessage(t('canvas.error.winter'));
    }
}
